...
Both subcommands are meant to be usable by hand from an MSYS2 shell, not only
...
def parser() -> argparse.ArgumentParser:
    ...
    planner.add_argument(
        ...
        help="Plan the packages touched since REF instead of comparing against "
             "the published repository. Used for pull requests.")
    planner.add_argument(
